  ...
  return (
    <main className="grid min-h-screen place-items-center bg-app-bg p-4">
      <form onSubmit={submit} className="card w-full max-w-md space-y-4 p-6">
        ...
        <button type="button" onClick={handleGoogle} className="btn w-full border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 flex items-center justify-center gap-2">
